...
argsToAvArgs : userenv -> (userenv -> Context -> String -> Array.Array ArgValue -> Result String OutVal) -> Context -> List Expr -> Input
...
argsToOutVal : userenv -> (userenv -> Context -> String -> Array.Array ArgValue -> Result String OutVal) -> Context -> List Expr -> Array.Array OutVal
...
evaluate : userenv -> (userenv -> Context -> String -> Array.Array ArgValue -> Result String OutVal) -> Context -> Expr -> ExprResult String OutVal ( String, Array.Array ArgValue )
evaluate userenv userfunc context expr =
    case expr of
        Variable name ->
            let
            ...
            case func__ of
                ...
                _ ->
                    ...
                    case func_ of
                        ...
                        --    ExprOk (userfunc userenv context name args_)
                        _ ->
                              case (userfunc userenv context name args_) of
                                 Ok r ->
                                       ExprOk r
                                 Err str ->
                                       ExprErr str
